...
namespace Online_Pet_Supplies.Application_Layer.MainSite
{
    public partial class Registration : System.Web.UI.Page
    {
        ...
        protected void btnSubmitRegistrationForm_Click(object sender, EventArgs e)
        {
            ...
            int registered = reg.RegisterUser(txtFirstName.Text, txtLastName.Text, txtStreet.Text, txtTown.Text, txtPostCode.Text, txtEmailAddress.Text, txtPassword1.Text,cusType);
            if (registered == 1)
            {
